...
const App: NextPage = () => {
  return (
    <>
      ...
      <main className="bg-gray-100 light:bg-gray-800 h-screen overflow-hidden relative">
        <div className="flex items-start justify-between">
          <div className="h-screen hidden lg:block shadow-lg relative w-80">
            <div className="bg-white h-full light:bg-gray-700">
              ...
              <nav className="mt-6">
                <div>
                  <a className="w-full text-gray-800 light:text-white flex items-center pl-6 p-2 my-2 transition-colors duration-200 justify-start border-l-4 border-purple-500" href="#">
            ...
            <div className="overflow-auto h-screen pb-24 px-4 md:px-6">
              ...
              <div className="flex my-6 items-center w-full space-y-4 md:space-x-4 md:space-y-0 flex-col md:flex-row">
                    ...
                    <a href="#" className="w-full h-full block">
                      <div className="flex items-center justify-between px-4 py-6 space-x-4">
                        <div className="flex items-center">
                          ...
                          <p className="text-sm text-gray-700 light:text-white ml-2 font-semibold border-b border-gray-200">
                            Level 2 Ambassador
                          </p>
                        </div>
                        <div className="border-b border-gray-200 mt-6 md:mt-0 text-black light:text-white font-bold text-xl">
                          $44,453.39
                ...
                <div className="flex items-center w-full md:w-1/2 space-x-4">
                  <div className="w-1/2">
                    <div className="shadow-lg px-4 py-6 w-full bg-white light:bg-gray-700 relative">
                      <p className="text-2xl text-black light:text-white font-bold">
                        12
                      </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 my-4">
                <div className="w-full">
                  <div className="shadow-lg px-4 py-6 w-full bg-white light:bg-gray-700 relative">
                    <p className="text-sm w-max text-gray-700 light:text-white font-semibold border-b border-gray-200">
                      Project Reffered
                    </p>
                    <div className="flex items-end space-x-2 my-6">
                      <p className="text-5xl text-black light:text-white font-bold">
                        12
                      </p>
